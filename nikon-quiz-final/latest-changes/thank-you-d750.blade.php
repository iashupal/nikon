        ...
        <div class="nik-upper-quiz-div">
            <div class="thankyou-main-div ">
                <div class="trophy-heading">
                    <img class="img-responsive" src="/common/images/trophy.png" />
                </div>
                <div class="congratulations-text">
                    <img class="img-responsive" src="/common/images/congrats.png" />
                </div>
                ...
                <div class="btns-div">
                    ...
                    <div class="back-btn check-answers">
                        <a href="{{url('test-staging/check-answers-d750')}}">Check Answers</a>
                    </div>
                </div>
                <div class="btns-div congrats-btn-div2">
                        <div class="back-btn fb-share">
                            <a href="#">Play for Nikon D5600</a>
                        </div>
                        <div class="back-btn check-answers">
