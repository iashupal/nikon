...
<head>
    ...
    <style>
        body {
            background-image: url(/common/images/quiz-img/quiz-mainpage1-bnr.png);
            height: 100%;
            width: 100%;
...
<body>
    ...
    <div class="home-main-div" style="display:flex;flex-wrap:wrap;height:100%;">
        ...
        <div class="main-right-div" style="width:50%;float:left">
            ...
            <div class="contest-main-img">
                <img src="/common/images/quiz-img/nik-logo2.png" class="img-responsive" />
            </div>
            <div class="form-div">
	            ...
	            <div class="fb-login" style="margin-top: 10px;">
                    <div class="or-text">
                        or
                    </div>
