        ...
        <div class="nik-upper-quiz-div">
            <div class="question-main-div">
                ...
                <!-- <div class="question2-main answer-div" style="display:none">
                    <div class="question-div">
                        <div class="question1">
                            How many megapixels does Nikon D750 have ?
                        </div>
                    </div>
                    <div class="answer1 answer">
                        <div class="answer-row-top">
                ...
                <div class="question3-main answer-div" style="display:none">
                    <div class="question-div">
                        <div class="question1">
                        Nikon D750 comes with a ______ screen. 
                        </div>
                    </div>
                    <div class="answer1 answer">
                        <div class="answer-row-top">
                ...
                <div class="question4-main answer-div" style="display:none">
                    <div class="question-div">
                        <div class="question1">
                        Nikon D750 can record ______ movie.
                        </div>
                    </div>
                    <div class="answer1 answer">
                        <div class="answer-row-top">
                ...
                <div class="question5-main answer-div" style="display:none">
                    <div class="question-div">
                        <div class="question1">
                        Nikon D750 has Auto Focus Points.
                        </div>
                    </div>
                    <div class="answer1 answer">
                        <div class="answer-row-top">
                ...
                <div class="question6-main answer-div" style="display:none">
                    <div class="question-div">
                        <div class="question1">
                        Nikon D750 has ______ image processor.
                        </div>
                    </div>
                    <div class="answer1 answer">
                        <div class="answer-row-top">
                ...
                <!-- <div class="question7-main answer-div" style="display:none">
                    <div class="question-div">
                        <div class="question1">
                            The ink used in Pilot V7 Cartridge System Pen is ______ and ______ for skip-free writing.
                        </div>
                    </div>
                    <div class="answer1 answer">
                        <div class="answer-row-top">
        ...
        function api() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    window.location.href = 'https://www.iamnikon.co.in/test-staging/d750-thankyou'
