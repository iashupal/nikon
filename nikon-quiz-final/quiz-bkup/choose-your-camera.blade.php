    ...
    <div class="main-div">
        <div class="quiz-inner-mob-banner">
            ...
            <div class="left-pen-div quiz-camera750">
                <a href="{{url('test-staging/d750-camera')}}"><img src="/common/images/quiz-img/nik-camera750.png" class="img-responsive" /></a>
            </div>
        </div>
        ...
        <div class="nik-quiz-start">
            <div class="question-main-div quiz-nik-camera5600">
                <div class="question1-main answer-div quiz-nik-side-div">
                        <a href="{{url('test-staging/d5600-camera')}}"><img src="/common/images/quiz-img/nik-camera5600.png" class="img-responsive" /></a>
